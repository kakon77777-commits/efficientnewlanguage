...
- **2026-07-25 起 — 案例語料庫每日擴充線（目前 786 個案例、16 條量測軸）。** 這條線是 Neo
  ...
  測試與 `pnpm monitor`，然後兩個 repo 一起發布、驗 production `build_id`。**截至 2026-09-10：
  語料庫 786 個程式，測試套件 3534 tests / 70 files。**
