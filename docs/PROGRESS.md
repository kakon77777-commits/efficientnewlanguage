...
- **2026-07-25 起 — 案例語料庫每日擴充線（目前 330 個案例、15 條量測軸）。** 這條線是 Neo
  ...
  測試與 `pnpm monitor`，然後兩個 repo 一起發布、驗 production `build_id`。**截至 2026-08-10：
  語料庫 330 個程式，測試套件 2020 tests / 60 files。**
